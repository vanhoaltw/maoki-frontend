...
const Footer = () => {
  return (
    <footer className="bg-secondary-100 border-white dark:bg-secondary-700 pt-4 border-t-2 dark:border-secondary-800">
      <Container>
        <div className="grid grid-cols-1 text-center sm:text-left sm:grid-cols-2 gap-8 px-4 md:grid-cols-4">
          <div>
            <img
          ...
          <div>
            ...
            <ul className=" dark: font-medium">
              ...
              <li className="flex gap-4 justify-center sm:justify-start items-center">
                ...
                >
                  <svg
                    className="w-4 lg:w-8 lg:h-8 h-4"
                    aria-hidden="true"
