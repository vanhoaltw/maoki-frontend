        ...
        <div className="text-center p-8">
          ...
          <div className="flex flex-wrap items-center mt-20 text-center">
            ...
            <div className="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
              ...
              <p className=" my-6">
                Ensure that your rooms and suites are comfortable,
          ...
          <div className="flex flex-wrap items-center my-20 text-center">
            ...
            <div className="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
              ...
              <p className="my-6">
                Provide a spa and wellness facility for relaxation, massages,
            ...
            <div className="md:flex md:items-center justify-center md:w-1/2">
              <div className="px-6 py-6 md:px-8 md:py-0">
                ...
                <p className="my-2 text-sm">
                  ...
                  exclusive deals at our top-rated hotels. Whether you're
                  planning a relaxing getaway or a business trip, our newsletter
                  will keep you informed and ensure you have a memorable stay
                  with us.
                </p>
              </div>
            </div>
